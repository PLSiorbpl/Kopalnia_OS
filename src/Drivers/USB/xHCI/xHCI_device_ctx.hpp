...
namespace USB {
    ...
    */
    ...
    struct xhci_device_context {
        ...
        xhci_endpoint_context<size> control_ep_context;

        // Optional communication endpoints
        xhci_endpoint_context<size> ep[30];
    } __attribute__((packed));
    ...
    */
    ...
    // Ensures structure sizes are correct
    static_assert(sizeof(xhci_input_context32) == sizeof(xhci_input_control_context32) + sizeof(xhci_device_context32), "32-byte input context should be 1056 bytes");
    static_assert(sizeof(xhci_input_context64) == sizeof(xhci_input_control_context64) + sizeof(xhci_device_context64), "64-byte input context should be 2112 bytes");
