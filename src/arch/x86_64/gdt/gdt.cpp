...
extern "C" {
    ...
    uint64_t gdt[] = {
        ...
        gdt_entry(0, 0, ACCESS_PRESENT | ACCESS_RING0 | ACCESS_DATA_SEG | ACCESS_READABLE, FLAG_64BIT), // 0x20
        gdt_entry(0, 0, ACCESS_PRESENT | ACCESS_RING3 | ACCESS_DATA_SEG | ACCESS_WRITABLE, FLAG_64BIT), // 0x28
        gdt_entry(0, 0, ACCESS_PRESENT | ACCESS_RING3 | ACCESS_CODE_SEG | ACCESS_WRITABLE, FLAG_64BIT), // 0x30
        0, // 0x38, TSS low
